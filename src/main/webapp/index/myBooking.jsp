...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/myBooking.css">
                ...
                <div class="content-left">
                    ...
                    <div class="menu_profile">
                        ...
                        <a href="qldonhang.html" class="item_menu_profile ">Đơn hàng
                            của tôi</a>
                        <a href="myBooking.html" class="item_menu_profile active">Booking của tôi</a>
                        <a href="addressbook.html" class="item_menu_profile ">Sổ địa chỉ
                            nhận hàng</a>
            ...
            <div class="body-right">
                <div class="content-right">
                    <div class="content-box">
                        <h5 class="title-1">Booking của tôi</h5>
                        <div class="box">
                            <h6 class="title-2">Bạn chưa có đơn đặt hàng nào ! </h6>
                            <button id="ids" class="btn-1">Tiếp tục mua sắm</button></div>
                    </div>
                </div>
            </div>
        </div>
