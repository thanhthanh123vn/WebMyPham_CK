    ...
    <div class="main_content_sub_login">
        <form id="form-head-register" action="https://hasaki.vn/register" method="post" novalidate="novalidate">
            <input name="form_key" type="hidden" value="9lB2QzSyHmzVefcW">                                <div class="block_more_login">
                ...
                <div class="form-group">
                    <div class="relative">
                        <input type="text" autocomplete="off" onkeyup="handleChangeUserName(this)" rel="#verifyUserName" class="form-control email" name="email" id="reg-email" placeholder="Nhập email hoặc số điện thoại">
                ...
                <div class="form-group ">
                    <div class="relative parent_code_register">
                        ...
                        <button type="button" onclick="handleVerify(this)" id="verifyUserName" data-error=".showRegisterMessage" rel="#reg-email" disabled="disabled">lấy mã</button>
                    </div>
                </div>
                <div class="form-group">
                    <div class="relative">
                        <input id="reg-password" autocomplete="off" name="password" type="password" placeholder="Nhập mật khẩu từ 6 - 32 ký tự" class="form-control">
                ...
                <div class="form-group">
                    <label class="checkbox-inline">
                        <input name="accept_policy_privacy" value="1" checked="checked" type="checkbox" id="reg-policy"> Tôi đã đọc và đồng ý với <a href="https://hotro.hasaki.vn/quy-dinh-giao-dich-chung.html" style="color: #326e51">Điều kiện giao dịch chung</a> và <a href="https://hotro.hasaki.vn/chinh-sach-bao-mat.html" style="color: #326e51">Chính sách bảo mật thông tin</a> của Hasaki                                    </label>
                </div>
                <div class="form-group">
                    <label class="checkbox-inline">
        ...
        <div class="block_login_fb">
            ...
            <a class="login-facebook" href="javascript:void(0);" data-href="https://hasaki.vn/login-facebook">
                <img src="https://hasaki.vn/images/graphics/img_login_fb_2.jpg" alt="" class="loading" data-was-processed="true">
            </a> &nbsp;
            <a class="login-google" href="javascript:void(0);" data-href="https://hasaki.vn/login-google">
                <img src="https://hasaki.vn/images/graphics/img_login_gg_2.jpg" alt="" class="loading" data-was-processed="true">
            </a>
        </div>
