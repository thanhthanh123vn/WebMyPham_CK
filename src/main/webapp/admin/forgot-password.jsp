                        ...
                        <div class="col-lg-6">
                            <div class="p-5">
                                <div class="text-center">
                                    ...
                                    <p class="mb-4">Chúng tôi hiểu, mọi chuyện đều có thể xảy ra. Chỉ cần nhập địa
                                        chỉ email của bạn bên dưới và chúng tôi sẽ gửi cho bạn liên kết để đặt lại mật khẩu!</p>
                                </div>
                                <form id="user">
                                    ...
                                    <a  class="btn btn-primary btn-user btn-block" onclick="SendEmail()">
                                        Đặt lại mật khẩu
                                    </a>
                                </form>
                                <hr>
