  ...
  <div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
      ...
      <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
          ...
          <main> <section class="products">
            <table id="userTable">
              ...
              <tr id="list-header">
                ...
                <th  scope="col" class="background-green bold ">Name</th>
                <th scope="col" class="background-green bold ">Phần trăm giảm giá</th>
                <th scope="col" class="background-green bold ">Ngày bắt đầu</th>
                <th scope="col" class="background-green bold ">Ngày kết thúc</th>
              ...
              <%--                                                     <td>${user.phone}</td>--%>
              <%--                                                     <td>--%>
              <%--                                                         <button onclick="editUser(${status.index})">Sửa</button>--%>
              <%--                                                         <button onclick="deleteUser(${status.index})">Xóa</button>--%>
              <%--                                                     </td>--%>
              <%--                                                 </tr>--%>
              <%--                                             </c:forEach>--%>
          ...
          <div id="promotionsModal"> <div id="promotionsModalContent">
    ...
    <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
      ...
      <%
       ...
       List<Promotions> users = (List<Promotions>) request.getAttribute("ManagerPromotions");
          String PromotionsJson = new Gson().toJson(users);
