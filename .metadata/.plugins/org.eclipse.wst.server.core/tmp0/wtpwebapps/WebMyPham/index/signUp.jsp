...
<body>
	<div class="main_content_sub_login">
		<form id="form-head-register" action="" method="post"
			...
			<div class="block_more_login">
				...
				<div class="form-group ">
					<div class="relative parent_code_register">
						...
						<button type="button" data-resend-time=""
							class="show-resend hidden" >
							<span class="minute">--</span>:<span class="second">--</span>
						</button>
						<button type="button" id="verifyUserName"
							data-error=".showRegisterMessage" >lấy
							mã</button>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group row">
					<div class="col-lg-4">
						<label class="radio-inline"><input name="gender" value="0"
							type="radio">Không xác định </label>
					</div>
					<div class="col-lg-2">
						<label class="radio-inline"><input name="gender" value="1"
							type="radio"> Nam </label>
					</div>
					<div class="col-lg-2">
						<label class="radio-inline"><input name="gender" value="2"
							type="radio" checked="checked"> Nữ </label>
					</div>
				</div>
				...
				<div class="form-group">
					<label class="checkbox-inline"> <input
						...
						style="color: #326e51">Chính sách bảo mật thông tin</a> của Hasaki
					</label>
				</div>
				<div class="form-group">
					<label class="checkbox-inline"> <input name="is_subscribed"
						value="1" checked="checked" type="checkbox"> Nhận thông
						tin khuyến mãi qua e-mail
					</label>
				</div>
...
<script>
    document.getElementById("verifyUserName").addEventListener("click", function() {
